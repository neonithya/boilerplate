...
var LokiDispatcher = /*#__PURE__*/function () {
  function LokiDispatcher(useWebWorker) {
    ...
    this._worker.onmessage = function ({
      ...
      var {
        callback: callback,
        id: id
      } = _this._pendingCalls.shift(); // sanity check
  ...
  _proto.call = function call(type, payload = [], callback, // NOTE: This are used when not using web workers (otherwise, the data naturally is just copied)

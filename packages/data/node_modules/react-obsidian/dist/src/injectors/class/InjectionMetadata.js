...
var InjectionMetadata = /** @class */ (function () {
    function InjectionMetadata() {
        ...
        this.lazyInjectionMetadataKey = 'lazyInjectionMetadataKey';
    }
    ...
    InjectionMetadata.prototype.getLazyPropertiesToInject = function (target) {
    ...
    InjectionMetadata.prototype.saveLazyPropertyMetadata = function (target, property) {
        this.saveProperties(this.lazyInjectionMetadataKey, this.getLazyPropertiesToInject(target).add(property), target);
    };
